...
func (r *SettingsRepository) Read(root string) ports.SettingsData {
	...
	return ports.SettingsData{
		...
		PlanGuardDisabled:               s.PlanGuardDisabled,
		...
		ContextCompressionLevel:         s.ContextCompressionLevel,
		ToolOutputCompression:           s.ToolOutputCompression,
		ConciseOutputDirective:          s.ConciseOutputDirective,
		CompressionMinTokens:            s.CompressionMinTokens,
