...
func TestDeriveVerdict_NoApruebaSinConsenso(t *testing.T) {
	...
	if got := DeriveVerdict(Review{MaxFixRounds: 2}, conHallazgos, nil, nil); got == VerdictApproved {
	...
	if got := DeriveVerdict(Review{MaxFixRounds: 2}, sinHallazgos, nil, nil); got != VerdictApproved {
